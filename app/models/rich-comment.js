...
module.exports = {
  ...
  findByLiterature: function (literatureId, cb) {
    var query = 'SELECT a.id AS id, a.content AS content, a.created_at AS created_at, a.score AS score, b.username AS username FROM ?? as a JOIN ?? as b ON a.user_id = b.id WHERE literature_id = ? AND publish = ? ORDER BY a.created_at DESC LIMIT 8';
